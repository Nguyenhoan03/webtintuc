...
#aetv1{
 background-color: red;
  ...
  <aside class="app-sidebar">
    ...
    <hr>
    <ul class="app-menu">
      <li><a class="app-menu__item haha" href="{{url('/posbanhang')}}"><i class='app-menu__icon bx bx-cart-alt'></i>
          <span class="app-menu__label"> POS Bán Hàng </span></a></li>
      <li><a class="app-menu__item " href="{{url('/bangdieukhien')}}"><i class='app-menu__icon bx bx-tachometer'></i><span
            class="app-menu__label">Bảng điều khiển</span></a></li>
   
          <li><a class="app-menu__item active" href="{{url('/themtin1')}}"><i class='app-menu__icon bx bx-id-card'></i>
          <span class="app-menu__label">quản lý sản phẩm</span></a></li>
   
      </li>
      <li><a class="app-menu__item" href="{{url('/quanlydonhang')}}"><i class='app-menu__icon bx bx-task'></i><span
            class="app-menu__label">Quản lý đơn hàng</span></a></li>
      <li><a class="app-menu__item" href="{{url('/quanlynoibo')}}"><i class='app-menu__icon bx bx-run'></i><span
            class="app-menu__label">Quản lý nội bộ
          </span></a></li>
      <li><a class="app-menu__item" href="{{url('bangkeluong')}}"><i class='app-menu__icon bx bx-dollar'></i><span
            class="app-menu__label">Bảng kê lương</span></a></li>
      <li><a class="app-menu__item" href="{{url('/baocaodoanhthu')}}"><i
    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="tile">
         ...
         <h3 class="tile-title" id="aetv1">Tạo mới TIN1</h3>
         <a href="{{url('/themxuhuong')}}"> <h3 class="tile-title" id="aetv2" >Tạo mới xu hướng</h3></a>
         ...
         <a href="{{url('/themphobiennhat')}}"> <h3 class="tile-title" id="aetv5">Tạo mới PHỔ BIẾN NHẤT</h3></a>
          ...
          <div class="tile-body">
            ...
            <h2 style="color:red">thêm: tin1</h2> <br>

            <form action="{{url('themtin1')}}" method="POST" enctype="multipart/form-data">
                 @csrf
                ...
                <button style="background-color: red">add tin 1</button>
...
@foreach($ttin1 as $key)
    <tr>
      ...
      <td><button><a href="{{url('suatin1',[$key->id])}}"> sửa </a></button></td>
      <td><button><a href="{{url('/xoatin1',[$key->id])}}"> xóa </a></button></td>
