    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <a href="{{url('/themtin1')}}"> <h3 class="tile-title" id="aetv1">Tạo mới TIN1</h3></a>
         ...
         <a href="">  <h3 class="tile-title" id="aetv3" style="background-color:red;">Tạo mới TIN TỨC 1</h3></a>
         ...
         <a href="{{url('/themphobiennhat')}}"> <h3 class="tile-title" id="aetv5">Tạo mới PHỔ BIẾN NHẤT</h3></a>
          ...
          <div class="tile-body">
            ...
            <h2 style="color:red">thêm: tin tức 1</h2> <br>

            <form action="{{url('themtintuc1')}}" method="POST" enctype="multipart/form-data">
                 @csrf
                ...
                <button style="background-color: red">add tin tức 1</button>
...
@foreach($tt1 as $key)
    ...
    <td>{{$key->hinhanh}}</td>
      ...
      <td><button><a href="{{url('suatintuc1',[$key->id])}}"> sửa </a></button></td>
      <td><button><a href="{{url('/xoatintuc1',[$key->id])}}"> xóa </a></button></td>
