...
<div class="container-fluid paddding mb-5">
    ...
    <div class="row mx-0">
        ...
        <div class="col-md-6 col-12 paddding animate-box" data-animate-effect="fadeIn">
            <div class="fh5co_suceefh5co_height"><img class="img-fluid" src="{{$tinchinh->hinhanh1}}" alt="img"/>
                <div class="fh5co_suceefh5co_height_position_absolute"></div>
                <div class="fh5co_suceefh5co_height_position_absolute_font">
                 <a href="/tinchinh/{{$tinchinh->slug}}"> <p class="bestyasuo"> {{$tinchinh->title}}</p>
                  {{$tinchinh->description}}</a>
        ...
        <div class="col-md-6">
            <div class="row">
                @foreach($tinphu as $tp)
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img class="img-fluid" src="{{$tp->hinhanh1}}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                           
                            <div class=""><a href="{{url('24h_news/'.$tp->slug,[$tp->id])}}" class="fh5co_good_font_2"> {{$tp->description}} </a></div>
                        </div>
                    </div>
                </div>
          @endforeach
        ...
        @foreach($ldl3 as $xh)
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img class="img-fluid" src="{{$xh->hinhanh1}}" alt=""
                                                           class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="{{url('detail_xuhuong/'.$xh->slug,[$xh->id])}}" class="text-white"> {{$xh->title}} </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> {{$xh->description}}</div>
                    </div>
                </div>
            </div>
       @endforeach
        ...
        @foreach($ldl2 as $tt1)
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img class="img-fluid" src="{{$tt1->hinhanh1}}" alt=""/></div>
                    <div>
                        <a href="{{url('detail_tintuc1/'.$tt1->slug,[$tt1->id])}}" class="d-block fh5co_small_post_heading"><span class="">{{$tt1->title}}</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i>{{$tt1->description}}</div>
                    </div>
                </div>
            </div>
...
@foreach($ldl as $laydl)
                <div class="row pb-4">
                    ...
                    <div class="col-md-7 animate-box">
                        <a href="{{url('detail_tintuc2/'.$laydl->slug,[$laydl->id])}}" class="fh5co_magna py-2"> {{$laydl->title}} </a> 
