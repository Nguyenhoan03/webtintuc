    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$detail_thegioitunhien->title}}</div>
                </div>
                <div class="row pb-4">
                ...
                <p>{{$detail_thegioitunhien->description}}</p>
                 

    

                    <p><img class="img-fluid" src="{{$detail_thegioitunhien->hinhanh1}}" style="width:700px;height:450px"  alt=""></p>

                  

                    <p>{{$detail_thegioitunhien->content}}</p>
