    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$detail_tinphu_ldl->title}}</div>
                </div>
                <div class="row pb-4">
                ...
                <p>{{$detail_tinphu_ldl->description}}</p>
                 

    

                    <p><img class="img-fluid" src="{{$detail_tinphu_ldl->hinhanh1}}" style="width:700px;height:450px"  alt=""></p>

                  

                    <p>{{$detail_tinphu_ldl->content}}</p>
                ...
                <hr>
                @foreach($comment_tinphu as $cmmt1)
        ...
        @foreach($detail_xh as $key)
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    ...
                    <div>
                        <a href="{{url('/detail_tintuc2/'.$key->slug,[$key->id])}}" class="d-block fh5co_small_post_heading"><span class="">{{$key->title}}</span></a>
