    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$detail_tulieu->title}}</div>
                </div>
                <div class="row pb-4">
                ...
                <p>{{$detail_tulieu->description}}</p>
                 

    

                    <p><img class="img-fluid" src="{{$detail_tulieu->hinhanh1}}" style="width:700px;height:450px"  alt=""></p>

                  

                    <p>{{$detail_tulieu->content}}</p>
            ...
            <div class="col-md-3 animate-box" data-animate-effect="fadeInRight">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img class="img-fluid" src="images/download (1).jpg" alt="img" class="fh5co_most_trading"/>
                    </div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img class="img-fluid" src="images/allef-vinicius-108153.jpg" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center">
                        <img class="img-fluid" src="images/download (2).jpg" alt="img" class="fh5co_most_trading"/>
                    </div>
                    <div class="col-7 paddding">
                        <div class="most_fh5co_treding_font"> Magna aliqua ut enim ad minim veniam quis nostrud.</div>
                        <div class="most_fh5co_treding_font_123"> April 18, 2016</div>
                ...
                <div class="row pb-3">
                    <div class="col-5 align-self-center"><img class="img-fluid" src="images/seth-doyle-133175.jpg" alt="img"
