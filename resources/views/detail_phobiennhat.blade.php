    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$detail_phobiennhat->noidungchinh}}</div>
                </div>
                <div class="row pb-4">
                    

                    <p>{{$detail_phobiennhat->noidung1}}</p>
                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_phobiennhat->hinhanh1}}" alt=""></p>
                    <p>{{$detail_phobiennhat->noidung2}}</p>
                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_phobiennhat->hinhanh2}}" alt=""></p>
                    <p>{{$detail_phobiennhat->noidung3}}</p>
                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_phobiennhat->hinhanh3}}" alt=""></p>
                    <p>{{$detail_phobiennhat->noidung4}}</p>
                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_phobiennhat->hinhanh4}}" alt=""></p>
                    <p>{{$detail_phobiennhat->noidung5}}</p>
                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_phobiennhat->hinhanh5}}" alt=""></p>
                    <p>{{$detail_phobiennhat->noidung6}}</p>
                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_phobiennhat->hinhanh6}}" alt=""></p>
        ...
        @foreach($detail_xh as $key)
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    ...
                    <div>
                        <a href="{{url('/detail_xuhuong/'.$key->slug,[$key->id])}}" class="d-block fh5co_small_post_heading"><span class="">{{$key->noidungchinh}}</span></a>
