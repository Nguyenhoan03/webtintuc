    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-md-3 fh5co_padding_menu">
                <img class="img-fluid" src="site/images/logo.png" alt="img" class="fh5co_logo_width"/>
            </div>
            <div class="col-12 col-md-9 align-self-center fh5co_mediya_right">
                ...
                <!--<div class="d-inline-block text-center"><img class="img-fluid" src="site/images/country.png" alt="img" class="fh5co_country_width"/></div>-->
...
<div class="container-fluid pb-4 pt-4 paddding">
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">từ khóa: {{$tukhoaxuhuong}}</div>
    ...
    <div class="container animate-box" data-animate-effect="fadeIn">
        ...
        @foreach($timkiemxuhuong as $xh)
            <div class="item px-2">
                <div class="fh5co_latest_trading_img_position_relative">
                    <div class="fh5co_latest_trading_img"><img class="img-fluid" src="site/images/{{$xh->hinhanh1}}" alt=""
                                                           class="fh5co_img_special_relative"/></div>
                    <div class="fh5co_latest_trading_img_position_absolute"></div>
                    <div class="fh5co_latest_trading_img_position_absolute_1">
                        <a href="{{url('detail_xuhuong/'.$xh->slug,[$xh->id])}}" class="text-white"> {{$xh->noidungchinh}} </a>
                        <div class="fh5co_latest_trading_date_and_name_color"> {{$xh->tacgia}} - {{$xh->thoigian}}</div>
                    </div>
                </div>
            </div>
       @endforeach
...
<br>
    ...
    <div class="col-md-6">
            <div class="row">
                @foreach($timkiemtin1 as $tinmot)
                <div class="col-md-6 col-6 paddding animate-box" data-animate-effect="fadeIn">
                    <div class="fh5co_suceefh5co_height_2"><img class="img-fluid" src="site/images/{{$tinmot->hinhanh1}}" alt="img"/>
                        <div class="fh5co_suceefh5co_height_position_absolute"></div>
                        <div class="fh5co_suceefh5co_height_position_absolute_font_2">
                            <div class=""><a href="#" class="color_fff"> <i class="fa fa-clock-o"></i>{{$tinmot->thoigian}}</a></div>
                            <div class=""><a href="{{url('detail_tin1/'.$tinmot->slug, [$tinmot->id])}}" class="fh5co_good_font_2"> {{$tinmot->noidungchinh}} </a></div>
                        </div>
                    </div>
                </div>
          @endforeach
...
@foreach($timkiemtintuc1 as $tt1)
    <div class="item px-2">
        <div class="fh5co_hover_news_img">
            <div class="fh5co_news_img"><img class="img-fluid" src="site/images/{{$tt1->hinhanh}}" alt=""/></div>
            <div>
                <a href="{{url('detail_tintuc1/'.$tt1->slug,[$tt1->id])}}" class="d-block fh5co_small_post_heading"><span class="">{{$tt1->noidungchinh}}</span></a>
                <div class="c_g"><i class="fa fa-clock-o"></i>{{$tt1->thoigian}}</div>
            </div>
        </div>
    </div>
...
@foreach($timkiemtintuc2 as $tt2)
                <div class="row pb-4">
                    <div class="col-md-5">
                        <div class="fh5co_hover_news_img">
                            <div class="fh5co_news_img"><img class="img-fluid" src="site/images/{{$tt2->hinhanh}}" alt=""/></div>
                            <div></div>
                        </div>
                    </div>
                    <div class="col-md-7 animate-box">
                        <a href="{{url('detail_tintuc2/'.$tt2->slug,[$tt2->id])}}" class="fh5co_magna py-2"> {{$tt2->noidungchinh}} </a> <a href="{{url('detail_tintuc2/'.$tt2->slug,[$tt2->id])}}" class="fh5co_mini_time py-3">{{$tt2->tacgia}} -
                        {{$tt2->thoigian}} </a>
                        <div class="fh5co_consectetur">{{$tt2->noidungphu}}
                        </div>
                    </div>
                </div>
