    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$detail_thoisu->title}}</div>
                </div>
                <div class="row pb-4">
                ...
                <p>{{$detail_thoisu->description}}</p>
                 

    

                    <p><img class="img-fluid" src="{{$detail_thoisu->hinhanh1}}" style="width:700px;height:450px"  alt=""></p>

                  

                    <p>{{$detail_thoisu->content}}</p>
...
<div class="container-fluid fh5co_footer_bg pb-3">
    <div class="container animate-box">
        <div class="row">
        <div class="col-12 spdp_right py-5"><img class="img-fluid" src="site/images/white_logo.png" alt="img" class="footer_logo"/></div>            <div class="clearfix"></div>
