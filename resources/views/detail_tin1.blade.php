    ...
    <div class="container paddding">
        <div class="row mx-0">
            <div class="col-md-8 animate-box" data-animate-effect="fadeInLeft">
                <div>
                    <div class="fh5co_heading fh5co_heading_border_bottom py-2 mb-4">{{$detail_tin1->noidungchinh}}</div>
                </div>
                <div class="row pb-4">
                    

                    <p>{{$detail_tin1->noidung1}}</p>
                    <?php
if($detail_tin1->hinhanh1 != " "){
    
?>

                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh1}}" style="width:700px;height:450px"  alt=""></p>
<?php }else{
?>

<p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh1}}" style="display:none"  alt=""></p>

<?php } ?>
                    <p>{{$detail_tin1->noidung2}}</p>
                    <?php
if($detail_tin1->hinhanh2 != " "){
    
?>

                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh2}}" style="width:700px;height:450px"  alt=""></p>
<?php }else{
?>

<p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh2}}" style="display:none"  alt=""></p>

<?php } ?>
                    <p>{{$detail_tin1->noidung3}}</p>
                    <?php
if($detail_tin1->hinhanh3 != " "){
    
?>

                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh3}}" style="width:700px;height:450px"  alt=""></p>
<?php }else{
?>

<p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh3}}" style="display:none"  alt=""></p>

<?php } ?>
                    <p>{{$detail_tin1->noidung4}}</p>
                    <?php
if($detail_tin1->hinhanh4 != " "){
    
?>

                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh4}}" style="width:700px;height:450px"  alt=""></p>
<?php }else{
?>

<p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh4}}" style="display:none"  alt=""></p>

<?php } ?>

                    <p>{{$detail_tin1->noidung5}}</p>
                    <?php
if($detail_tin1->hinhanh5 != " "){
    
?>

                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh5}}" style="width:700px;height:450px"  alt=""></p>
<?php }else{
?>

<p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh5}}" style="display:none"  alt=""></p>

<?php } ?>
                    <p>{{$detail_tin1->noidung6}}</p>

                    <?php
if($detail_tin1->hinhanh6 != " "){
    
?>

                    <p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh6}}" style="width:700px;height:450px"  alt=""></p>
<?php }else{
?>

<p><img class="img-fluid" src="{{url('site')}}/images/{{$detail_tin1->hinhanh6}}" style="display:none"  alt=""></p>

<?php } ?>


                </div><hr>
                @foreach($comment_tin1 as $cmmt1)
...
<div class="container-fluid pb-4 pt-5">
    <div class="container animate-box">
        ...
        @foreach($detail_tintuc1 as $key)
            <div class="item px-2">
                <div class="fh5co_hover_news_img">
                    <div class="fh5co_news_img"><img class="img-fluid" src="{{url('site')}}/images/{{$key->hinhanh1}}" alt=""/></div>
                    <div>
                        <a href="{{url('/detail_tintuc1/'.$key->slug,[$key->id])}}" class="d-block fh5co_small_post_heading"><span class="">{{$key->noidungchinh}}</span></a>
                        <div class="c_g"><i class="fa fa-clock-o"></i> {{$key->thoigian}}</div>
                    </div>
                </div>
            </div>
